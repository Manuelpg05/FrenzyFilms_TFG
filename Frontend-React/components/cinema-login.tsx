...
import { Eye, EyeOff, Film, Ticket } from "lucide-react"
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8 relative">
        ...
        <div className="relative z-10 bg-black/80 backdrop-blur-sm border border-red-900/50 p-8 rounded-2xl shadow-2xl">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={handleChange}
                  className={`bg-gray-900 border-gray-700 text-white pr-10 ${errors.password ? "border-red-500" : ""}`}
                />
                <button
                  type="button"
        ...
        <div className="text-center mt-8">
          <p className="text-xs text-gray-500">© 2024 CineMax. Todos los derechos reservados.</p>
        </div>
      </div>
    </div>
  )
